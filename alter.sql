...
-- add column
ALTER TABLE user2
ADD COLUMN email VARCHAR(50) DEFAULT 'person@gmail.com' NOT NULL;
...
-- add constraints
ALTER TABLE user2 ALTER COLUMN age set NOT NULL;
-- delete constraints
ALTER TABLE user2 ALTER COLUMN age DROP NOT NULL;

-- add a unique column
ALTER TABLE user3 ADD CONSTRAINT unique_user2_age PRIMARY KEY (id);
